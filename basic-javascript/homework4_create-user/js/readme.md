...
Если функция является частью объекта, она называется методом. Метод - это функция, ассоциированная с объектом, т.е. это свойство объекта, являющееся функцией. Методы определяются так же, как и обычные функции, за исключением того, что они присваиваются свойству объекта.
## Задание
